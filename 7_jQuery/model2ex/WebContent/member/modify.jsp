		...
		<form action="${conPath }/modify.do" method="post"
			...
			<table>
				<tr>
					...
					<td rowspan="4"><img
						src="${conPath }/memberPhotoUp/${member.mPhoto}" width="150">
					</td>
				</tr>
				<tr>
					<th>비밀번호</th>
				...
				<tr>
					<td colspan="3"><input type="submit" value="정보수정" class="btn"> <input
						type="reset" value="취소" class="btn"> <input type="reset" value="이전"
						onclick="history.go(-1)" class="btn"></td>
				</tr>
			</table>
		</form>
	</div>
