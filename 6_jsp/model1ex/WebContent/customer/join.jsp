	...
	function chkJoinInfo() {
		...
		if (frmJoin.cemail.value.length != 0
				&& (frmJoin.cemail.value.indexOf('@') <= 0
						|| frmJoin.cemail.value.lastIndexOf('@') == frmJoin.cemail.value.length - 1 || frmJoin.cemail.value
						.lastIndexOf('@') > frmJoin.cemail.value
						.lastIndexOf('.'))) {
			alert('메일을 확인하세요');
			...
			<table>
				...
				<tr>
					...
					<td><input type="tel" name="ctel" id="ctel"
						required="required" value="010-"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="radio" name="cgender" value="m"
						...
						type="radio" name="cgender" value="f" id="f"><label
						for="f">여자</label></td>
				</tr>
				<tr>
					<td colspan="2"></td>
