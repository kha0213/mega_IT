...
<body>
  ...
  <thead>
    <tr>
      <th scope="col" colspan="2">회원 가입</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th scope="row">아이디</th>
      <td><input type="text" name="mId" required="required" class="form-control"></td>
    </tr>
    <tr>
    ...
    <tr>
      <th scope="row">이름</th>
      <td><input type="text" name="mName" required="required" class="form-control"></td>
    </tr>
    <tr>
      <th scope="row">메일</th>
      <td><input type="text" name="mEmail" class="form-control"></td>
    </tr>
    <tr>
      <th scope="row">사진</th>
     ...
     <tr>
      ...
      <td><input type="date" name="mBirth" class="form-control"></td>
    </tr>
    <tr>
      <th scope="row">주소</th>
      <td><input type="text" name="mAddress" class="form-control"></td>
    </tr>
    <tr>
